...
public class turret1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            FindObjectOfType<hat1>().enable();
            detec.Play();
            StartCoroutine(FindObjectOfType<hat1>().disable());
        }
        ...
        {
            RaycastHit hit;
            //check if player is in direct los, no objects in between
    ...
    //turret detected player, start shooting
    IEnumerator shoot()
    {
        //wait befor shooting
